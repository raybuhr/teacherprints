...
do
   sudo mkdir -p /home/${UARRAY[${UNUM}]}/.conda/envs/teacherprints
   sudo chmod -R 777 /home/${UARRAY[${UNUM}]}/.conda/envs/teacherprints
   printf "\n>> User: ${UARRAY[${UNUM}]}"
   ...
   sudo chmod 755 ${UARRAY[${UNUM}]}:${UARRAY[${UNUM}]} /home/${UARRAY[${UNUM}]}/.conda
   (( UNUM+=1 ))
done
...
# https://askubuntu.com/questions/982589/why-should-i-be-installing-my-applications-in-the-opt-location